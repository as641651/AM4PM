...
function write_algorithm3_to_eventlog(io, id, stamps)
    write( io, string(id, ";", "gemm_6.75e+04;", "6.75e+04;", "tmp3 = (C D);", "gemm!('N', 'N', 1.0, ml2, ml3, 0.0, ml4);", string(stamps[1]), ";", string(stamps[2]), '
'  ))
    write( io, string(id, ";", "gemm_6.75e+04;", "6.75e+04;", "tmp5 = (B tmp3);", "gemm!('N', 'N', 1.0, ml1, ml4, 0.0, ml5);", string(stamps[2]), ";", string(stamps[3]), '
'  ))
    write( io, string(id, ";", "gemm_8.44e+05;", "8.44e+05;", "tmp6 = (A tmp5);", "gemm!('N', 'N', 1.0, ml0, ml5, 0.0, ml6);", string(stamps[3]), ";", string(stamps[4]), '
'  ))
end