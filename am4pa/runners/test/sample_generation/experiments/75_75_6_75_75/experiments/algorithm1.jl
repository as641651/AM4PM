...
'  ))
    write( io, string(id, ";", "gemm_6.75e+04;", "6.75e+04;", "tmp3 = (C D);", "gemm!('N', 'N', 1.0, ml2, ml3, 0.0, ml5);", string(stamps[2]), ";", string(stamps[3]), '
'  ))
    write( io, string(id, ";", "gemm_6.75e+04;", "6.75e+04;", "tmp6 = (tmp1 tmp3);", "gemm!('N', 'N', 1.0, ml4, ml5, 0.0, ml6);", string(stamps[3]), ";", string(stamps[4]), '
'  ))
end